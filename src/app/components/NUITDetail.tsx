...
import seniors_sam from "../../assets/nuit/seniors+sam.jpg"; 
import podium from "../../assets/nuit/podium.jpg"; 
...
export function NUITDetail() { 
  return ( 
    <ExperienceDetail 
      ...
      /* FIXED: Kept images as pure asset references */
      photos={[seniors_sam, podium, seniors]} 
      
      /* FIXED: Break container constraints using flex/height properties within the style string injection */
      photoPositions={[
        "50% 20%; aspect-ratio: 16/9; max-height: 240px;", // Top (Sam) shorter
        "center 75%;", // Middle (Podium) tallest
        "center 47%" // Bottom standard
      ]}
